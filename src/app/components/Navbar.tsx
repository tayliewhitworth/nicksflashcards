        ...
        >
          <div className="flex lg:flex-1">
            <Link href="#" className="-m-1.5 p-1.5">
              ...
              <Image src="/images/smileyFace.png" width={30} height={30} alt="Logo" className="invert rounded"/>
            </Link>
          </div>
          <div className="flex lg:hidden">
            <button
              type="button"
              className="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-indigo-400"
